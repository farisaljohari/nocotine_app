...
if ($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    SET competition.receiver_accept = '1'
    WHERE competition.sender_id = ".$User_id_sender." AND competition.receiver_id = ".$User_id_receiver."";
    $sql2 = "DELETE FROM `notification` WHERE notification.user_id_reciever=".$User_id_receiver." AND notification.user_id_sender=".$User_id_sender." AND notification.icon='competition'";    
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            echo '{ "message": "update competition accept successfully"}';
