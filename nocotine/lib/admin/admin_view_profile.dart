...
class AdminViewProfileScreen extends StatefulWidget {
    AdminViewProfileScreen({ Key? key,required this.userId}) : super(key: key);
    final String userId;
  @override
  _AdminViewProfileScreenState createState() => _AdminViewProfileScreenState();
}
...
class _AdminViewProfileScreenState extends State<AdminViewProfileScreen> {
              ...
              Column(
                ...
                Column(
                  ...
                  Container(
                    ...
                    Text("${numOfCigg.toInt()}",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: AppColor.infoyColor),),
                  ],
                ),
                ),
                ),
  ...
  //send requst to get user data for the user
  loadUserIdProfile()async{
    ...
    if(res.statusCode==200){
      ...
      numOfCigg=double.parse(UserData[0]['number_of_packets'])*20;
      _loadTotalwins();
    });
    }
